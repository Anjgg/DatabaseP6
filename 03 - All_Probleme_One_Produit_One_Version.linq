...
async Task Main()
{
	...
	var result = await Tickets.Include(t => t.ProduitSystemeExploitationVersion)
							  ...
							  .Where (t => t.Statut == "En cours" && t.ProduitSystemeExploitationVersion.Produit.Name == nameProduct && t.ProduitSystemeExploitationVersion.Version.NumVersion == numVersion)
